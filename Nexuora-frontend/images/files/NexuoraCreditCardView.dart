...
class NexuoraCreditCardView extends StatefulWidget {
  ...
  @override
  NexuoraCreditCardViewState createState() => NexuoraCreditCardViewState();
}

class NexuoraCreditCardViewState extends State<NexuoraCreditCardView> {
  @override
  void initState() {
    super.initState();
  }
