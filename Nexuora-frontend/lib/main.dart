...
import 'package:nexuora/screen/register_screen.dart';
import 'package:nexuora/store/AppStore.dart';
import 'package:nexuora/utils/AnalyticsService.dart';
...
import 'package:nexuora/utils/AppTheme.dart';
...
void main() async {
  ...
  try {
    ...
    printLogData("Error loading .env file: $e");
  }
