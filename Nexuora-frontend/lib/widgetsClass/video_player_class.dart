import 'package:nexuora/externalClasses/nexuora_video_player.dart';
...
class VideoPlayerClass {
  ...
  Widget getVideoPlayerDefaultWidget(WidgetModel widgetModel) {
    Widget _childData = AbsorbPointer(
      ...
      child: NexuoraVideoPlayer(url: url ?? DEFAULT_VIDEO_PLAYER_URL),
    );
  ...
  getHeaderClassFiles() {
    return ["import 'nexuora_video_player.dart';"];
  }
