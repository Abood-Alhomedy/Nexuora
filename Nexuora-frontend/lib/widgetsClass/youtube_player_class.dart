import 'package:nexuora/externalClasses/nexuora_youtube_player.dart';
...
class YoutubePlayerClass {
  ...
  Widget getYoutubePlayerDefaultWidget(WidgetModel widgetModel) {
    Widget childData;
    childData = NexuoraYoutubePlayer(
  ...
  getHeaderClassFiles() {
    return ["import 'nexuora_youtube_player.dart';"];
  }
