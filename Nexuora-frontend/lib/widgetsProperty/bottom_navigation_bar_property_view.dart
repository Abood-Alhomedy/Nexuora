...
class BottomNavigationBarPropertyView extends StatefulWidget {
  @override
  BottomNavigationBarPropertyViewState createState() =>
      BottomNavigationBarPropertyViewState();
}

class BottomNavigationBarPropertyViewState
    extends State<BottomNavigationBarPropertyView> {
  var bottomNavigationBarClass;

  init() async {
    appStore.setValueErrorMsg("");
    bottomNavigationBarClass = appStore.currentSelectedWidget!.widgetViewModel
        as BottomNavigationBarClass?;
  }
      ...
      children: [
          ...
          <Widget>[
            Column(
              ...
              children: List.generate(
                  bottomNavigationBarClass.bottomNavigationBarItems.length,
                  (index) {
                BottomNavigationBarItemModel item =
                    bottomNavigationBarClass.bottomNavigationBarItems[index];
                return Row(
                  children: [
                    iconPickerView(
                    ...
                    16.width,
                    closeIcon().onTap(() {
                      bottomNavigationBarClass.bottomNavigationBarItems
                          .removeAt(index);
                      setState(() {});
                      appStore.updateData(bottomNavigationBarClass);
                    }).visible(bottomNavigationBarClass
            ...
            Text(
              ...
              bottomNavigationBarClass.bottomNavigationBarItems[
                  bottomNavigationBarClass.bottomNavigationBarItems.length -
                      1] = BottomNavigationBarItemModel(
                  icon: IconResponse(
                      codePoint: 58136,
              ...
              appStore.updateData(bottomNavigationBarClass);
                ...
                bottomNavigationBarClass.bottomNavigationBarItems.length < 6),
          ],
        ),
        ExpansionTileView(
          ...
          <Widget>[
            ColorView(
              color: bottomNavigationBarClass.backgroundColor ??
                  BOTTOM_NAVIGATION_BG_COLOR,
              applyColor: () {
              ...
              pickColor: () {
                showColorPicker(
                    context,
                    bottomNavigationBarClass.backgroundColor ??
                        BOTTOM_NAVIGATION_BG_COLOR, applyOnWidget: (color) {
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: getTextField(
                  controller: TextEditingController(
                      text: bottomNavigationBarClass.currentIndex != null
                          ? bottomNavigationBarClass.currentIndex.toString()
                          : "0"),
                  ...
                  onChanged: (s) {
                    if (int.parse(s) >=
                        bottomNavigationBarClass
                            .bottomNavigationBarItems.length) {
                      appStore
                          .setValueErrorMsg(language!.currentIndexValidation);
                    } else {
                      bottomNavigationBarClass.currentIndex =
                          s.toString().isNotEmpty ? int.parse(s) : 0;
                      appStore.updateData(bottomNavigationBarClass);
                      appStore.setValueErrorMsg("");
                    }
                  },
        ...
        ExpansionTileView(language!.elevation, context, [
          Container(
            ...
            child: getTextField(
              controller: TextEditingController(
                text: bottomNavigationBarClass.elevation != null
                    ? bottomNavigationBarClass.elevation.toString()
                    : BOTTOM_NAVIGATION_ELEVATION.toString(),
              ),
              textAlign: TextAlign.center,
              inputFormatter: <TextInputFormatter>[
                FilteringTextInputFormatter.allow(RegExp('[0-9 .]')),
              ...
              onChanged: (s) {
                bottomNavigationBarClass.elevation = s.isNotEmpty
                    ? double.parse(s)
        ...
        ExpansionTileView(
          ...
          [
            Container(
              ...
              child: getTextField(
                controller: TextEditingController(
                  text: bottomNavigationBarClass.iconSize != null
                      ? bottomNavigationBarClass.iconSize.toString()
                      : DEFAULT_ICON_SIZE.toString(),
                ),
                textAlign: TextAlign.center,
                inputFormatter: <TextInputFormatter>[
                  FilteringTextInputFormatter.allow(RegExp('[0-9 .]')),
                ...
                onChanged: (s) {
                  if (double.parse(s) > 50) {
                    ...
                    bottomNavigationBarClass.iconSize = s.toString().isNotEmpty
                        ? double.parse(s)
                        : DEFAULT_ICON_SIZE;
                    appStore.updateData(bottomNavigationBarClass);
                  }
        ...
        ExpansionTileView(
          ...
          <Widget>[
            ColorView(
              color:
                  bottomNavigationBarClass.selectedItemColor ?? COMMON_BG_COLOR,
              applyColor: () {
              ...
              pickColor: () {
                showColorPicker(
                    context,
                    bottomNavigationBarClass.selectedItemColor ??
                        COMMON_BG_COLOR, applyOnWidget: (color) {
        ...
        ExpansionTileView(
          ...
          <Widget>[
            ColorView(
              color: bottomNavigationBarClass.unselectedItemColor ??
              ...
              pickColor: () {
                showColorPicker(
                    context,
                    bottomNavigationBarClass.unselectedItemColor ??
                        UNSELECTED_ITEM_COLOR, applyOnWidget: (color) {
        ...
        ExpansionTileView(
          ...
          [
            Container(
              ...
              child: getTextField(
                controller: TextEditingController(
                  text: bottomNavigationBarClass.selectedFontSize != null
                      ? bottomNavigationBarClass.selectedFontSize.toString()
                ...
                onChanged: (s) {
                  if (double.parse(s) > 30) {
                    ...
                    bottomNavigationBarClass.selectedFontSize =
        ...
        ExpansionTileView(
          ...
          [
            Container(
              ...
              child: getTextField(
                controller: TextEditingController(
                  text: bottomNavigationBarClass.unselectedFontSize != null
                      ? bottomNavigationBarClass.unselectedFontSize.toString()
                      : DEFAULT_FONT_SIZE.toString(),
                ),
                textAlign: TextAlign.center,
                inputFormatter: <TextInputFormatter>[
                ...
                onChanged: (s) {
                  if (double.parse(s) > 30) {
                    ...
                    bottomNavigationBarClass.unselectedFontSize =
                        s.toString().isNotEmpty
                            ? double.parse(s)
                            : DEFAULT_FONT_SIZE;
                    appStore.updateData(bottomNavigationBarClass);
