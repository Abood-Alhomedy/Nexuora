...
class NexuoraAudioPlayer extends StatefulWidget {
  final String? url;
  ...
  NexuoraAudioPlayer({this.url, this.iconSize, this.activeTrackColor, this.inactiveTrackColor, this.thumbColor, this.iconColor});

  @override
  _NexuoraAudioPlayerState createState() => _NexuoraAudioPlayerState();
}

class _NexuoraAudioPlayerState extends State<NexuoraAudioPlayer> {
