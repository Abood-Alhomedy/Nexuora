...
import 'package:nexuora/externalClasses/colorPicker/colorPickerUtils.dart';
...
class _BlockPickerState extends State<BlockPicker> {
  ...
  Widget build(BuildContext context) {
    return widget.layoutBuilder(
      ...
      (Color color, [bool? _, Function? __]) => widget.itemBuilder(color, _currentColor!.value == color.value, () => changeColor(color)),
    );
  }
}
