...
class AddScreenDialogState extends State<AddScreenDialog> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    afterBuildCreated(() {
      categoryTemplateList.add(CategoryTemplateData(name: "Blank Page"));
    });
  ...
  init() async {
    ...
    _tabController = TabController(length: categoryTemplateList.length, vsync: this);
  }
              ...
              children: [
                ...
                if (_tabController != null)
                  TabBar(
                    ...
                    tabs: List.generate(categoryTemplateList.length, (index) {
                      if (index == 0) {
                        return Tab(text: 'Blank Page');
                      }
                      CategoryTemplateData categoryTemplateData = categoryTemplateList[index];
                ...
                if (_tabController != null)
                  TabBarView(
                    controller: _tabController,
                    children: List.generate(categoryTemplateList.length, (index) {
                      if (index == 0) {
