...
class ScreenJsonData {
  ...
  ScreenJsonData.fromJson(Map<String, dynamic> json) {
    ...
    searchBarClass = json[WidgetTypeSearchBar] != null ? new SearchBarClass.fromJson(json[WidgetTypeSearchBar]) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.searchBarClass != null) {
      data[WidgetTypeSearchBar] = this.searchBarClass!.toJson();
    }
