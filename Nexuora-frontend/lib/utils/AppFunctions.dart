...
import 'package:nexuora/model/bottom_navigation_bar_item_model.dart';
import 'package:nexuora/model/download_model.dart';
import 'package:nexuora/model/drawer_Item_model.dart';
import 'package:nexuora/model/models.dart';
...
Future<List<String>> viewFinalSourceData(List<WidgetModel> selectedWidgetList, {DownloadModel? downloadModel}) async {
  ...
  if (appStore.bottomNavigationBarClass != null) {
    ...
    finalData.add("List<NexuoraBottomNavigationBarModel> nexuoraBottomNavigationBarItems = "
        "${items.map((data) {
      return "NexuoraBottomNavigationBarModel(icon:Icons.${data!.icon!.iconName},label:\"${data.label}\")";
    }).toList()}"
        ";");
    finalData.add("\n");
  }
  ...
  if (appStore.drawerClass != null) {
    ...
    finalData.add("List<NexuoraDrawerItemModel> NexuoraDrawerItems = "
        "${items.map((data) {
      return "NexuoraDrawerItemModel(icon:Icons.${data!.icon!.iconName},label:\"${data.label}\")";
    }).toList()}"
        ";");
    finalData.add("\n");
  }
...
getWidgetCasting(WidgetModel widgetModel) {
  if (widgetModel.widgetSubType == WidgetTypeText) {
    ...
    return widgetModel.widgetViewModel as SearchBarClass?;
  }
}
