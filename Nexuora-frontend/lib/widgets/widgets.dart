...
import 'package:nexuora/model/screen_json_data.dart';
import 'package:nexuora/model/widget_model.dart';
import 'package:nexuora/screen/code_view_screen.dart';
...
import 'package:nexuora/widgetsClass/Icon_class.dart';
import 'package:nexuora/widgetsClass/Image_class.dart';
import 'package:nexuora/widgetsClass/app_bar_class.dart';
import 'package:nexuora/widgetsClass/audio_player_class.dart';
import 'package:nexuora/widgetsClass/bottom_navigation_bar_class.dart';
import 'package:nexuora/widgetsClass/calender_class.dart';
import 'package:nexuora/widgetsClass/card_class.dart';
import 'package:nexuora/widgetsClass/checkbox_class.dart';
import 'package:nexuora/widgetsClass/checkbox_list_tile_class.dart';
import 'package:nexuora/widgetsClass/chip_view_class.dart';
import 'package:nexuora/widgetsClass/circle_image_class.dart';
import 'package:nexuora/widgetsClass/clip_rrect_class.dart';
import 'package:nexuora/widgetsClass/column_class.dart';
import 'package:nexuora/widgetsClass/constrained_box_class.dart';
import 'package:nexuora/widgetsClass/container_class.dart';
import 'package:nexuora/widgetsClass/credit_card_view_class.dart';
import 'package:nexuora/widgetsClass/divider_class.dart';
import 'package:nexuora/widgetsClass/drop_down_class.dart';
import 'package:nexuora/widgetsClass/google_map_class.dart';
import 'package:nexuora/widgetsClass/grid_view_class.dart';
import 'package:nexuora/widgetsClass/icon_button_class.dart';
import 'package:nexuora/widgetsClass/image_icon_class.dart';
import 'package:nexuora/widgetsClass/left_drawer_class.dart';
import 'package:nexuora/widgetsClass/linear_progress_indicator_class.dart';
import 'package:nexuora/widgetsClass/list_tile_class.dart';
import 'package:nexuora/widgetsClass/list_view_class.dart';
import 'package:nexuora/widgetsClass/lottie_animation_class.dart';
import 'package:nexuora/widgetsClass/opacity_class.dart';
import 'package:nexuora/widgetsClass/otp_text_field_class.dart';
import 'package:nexuora/widgetsClass/page_view_class.dart';
import 'package:nexuora/widgetsClass/radio_button_class.dart';
import 'package:nexuora/widgetsClass/search_bar_class.dart';
import 'package:nexuora/widgetsClass/rating_bar_class.dart';
import 'package:nexuora/widgetsClass/root_view_class.dart';
import 'package:nexuora/widgetsClass/rotated_box_class.dart';
import 'package:nexuora/widgetsClass/row_class.dart';
import 'package:nexuora/widgetsClass/sized_box_class.dart';
import 'package:nexuora/widgetsClass/slider_class.dart';
import 'package:nexuora/widgetsClass/stack_class.dart';
import 'package:nexuora/widgetsClass/switch_class.dart';
import 'package:nexuora/widgetsClass/switch_list_tile_class.dart';
import 'package:nexuora/widgetsClass/tab_bar_class.dart';
import 'package:nexuora/widgetsClass/tab_bar_view_class.dart';
import 'package:nexuora/widgetsClass/tab_class.dart';
import 'package:nexuora/widgetsClass/tab_view_class.dart';
import 'package:nexuora/widgetsClass/text_button_class.dart';
import 'package:nexuora/widgetsClass/text_class.dart';
import 'package:nexuora/widgetsClass/text_field_class.dart';
import 'package:nexuora/widgetsClass/video_player_class.dart';
import 'package:nexuora/widgetsClass/web_view_class.dart';
import 'package:nexuora/widgetsClass/youtube_player_class.dart';
...
List<WidgetModel> baseWidgetsList = [
  ...
  /// SearchBar View
  getWidgets(WidgetTypeSearchBar),
...
getWidgets(String? subType) {
  ...
  } else if (subType == WidgetTypeSearchBar) {
    /// SearchBar View
    return WidgetModel(
      id: getWidgetId(),
      title: getWidgetTitle(WidgetTypeSearchBar),
      displayWidget: getDisplayWidget(getWidgetsIcon(WidgetTypeSearchBar), getWidgetTitle(WidgetTypeSearchBar)),
      widgetSubType: WidgetTypeSearchBar,
      widgetViewModel: SearchBarClass(),
      widgetType: WidgetTypeNormal,
    );
...
getWidgetsClassData(
  ...
  } else if (widgetModel.widgetSubType == WidgetTypeSearchBar) {
    /// SearchBar View
    if (isChildData) {
      return (widgetModel.widgetViewModel as SearchBarClass).getDefaultSearchBarWidget(widgetModel);
    } else if (isCodeAsString) {
      return (widgetModel.widgetViewModel as SearchBarClass).getSearchBarString();
    } else if (isPropertyJsonData) {
      return (widgetModel.widgetViewModel as SearchBarClass).toJson();
    }
...
getWidgetJsonData(ScreenJsonData childData) {
  ...
  } else if (childData.subType == WidgetTypeSearchBar) {
    return childData.searchBarClass;
  } else {
    return null;
  }
}
